...
import com.ezreal.speex.encode.SpeexEncoder;
...
//	private Logger log = LoggerFactory.getLogger(SpeexRecorder.class);
	...
	public SpeexRecorder(String fileName, int quality) {
		super();
	...
	public void run() {
		...
		// Æô¶¯±àÂëÏß³Ì
		SpeexEncoder encoder = new SpeexEncoder(this.fileName, this.quality);
